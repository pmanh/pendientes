...
public class TypeController {
	...
	public GenericResult<Type> getAll(Type data){
	...
	public GenericStatus<Type> save(@RequestBody Type data, HttpServletRequest request){
	...
	public GenericStatus<Type> update(@RequestBody Type data,@PathVariable("id") int id){
		typeService.save(data);
	...
	@ResponseStatus(HttpStatus.OK)
	public GenericStatus<Type> delete(@PathVariable("id") int id){
